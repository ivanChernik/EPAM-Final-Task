				...
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="dropdown"><a
						...
						<ul class="dropdown-menu dropdown-button-style">
							<li><a href="searchingVacancy.jsp">${searchVacancies}</a></li>
							<li><a href="searchingResume.jsp">${searchResumes}</a></li>
						</ul></li>
					...
					<c:if test="${empty sessionScope.person}">
						<li>
							<form class="navbar-form" action="Controller" method="post">
								...
								<a href="index.jsp#popup-registration" class="btn btn-success">
									${singUp} </a>
							</form>
						</li>
					</c:if>
